...
def affine_batchnorm_relu_forward(x, w, b, gamma, beta, bn_param):
  """
  Convenience layer that performs an affine transform followed by batchnormalization followed by a ReLU
...
def affine_batchnorm_relu_backward(dout, cache):
  ...
  da = relu_backward(dout, relu_cache)
  dbatch, dgamma, dbeta = batchnorm_backward(da, bn_cache)
...
def conv_batchnorm_relu_forward(x, w, b, conv_param, gamma, beta, bn_param):
  """
  A convenience layer that performs a convolution followed by  Batch Normalization followed by a ReLU.
...
def conv_batchnorm_relu_backward(dout, cache):
  ...
  da = relu_backward(dout, relu_cache)
  dbatch, dgamma, dbeta = spatial_batchnorm_backward(da, bn_cache)
...
def conv_batchnorm_relu_pool_forward(x, w, b, conv_param, pool_param, gamma, beta, bn_param):
  """
  Convenience layer that performs a convolution, followed by batch normalization followed a ReLU, and then a pool.
